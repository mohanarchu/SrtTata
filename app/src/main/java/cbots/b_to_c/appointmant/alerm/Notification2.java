...
import cbots.b_to_c.appointmant.received.ReceivedAlerm;
...
public class Notification2 extends BroadcastReceiver implements UpdateModel, DataModel {
    ...
    public void success(int pos) {
        dataPresenter.getDetails(Checkers.getUserToken(Objects.requireNonNull(context)) , Checkers.getName(context),String.valueOf(Checkers.getRoleId(context)), new JsonObject());
    }
